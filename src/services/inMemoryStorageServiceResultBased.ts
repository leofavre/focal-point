/**
 * ResultBasedDatabaseService backed by a module-level in-memory storage (plain JavaScript).
 ...
 */
export function getInMemoryStorageServiceResultBased<T, K extends DatabaseKey = string>(
  tableName: string,
